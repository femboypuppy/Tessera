...
import { TAURI_ASSET_STORE_ID, TAURI_DOC_STORE_ID, TAURI_REGISTRY_ID } from './constants';
 ...
 * storage (priority 100) and, when a workspace opens, registers the workspace picker, quick
