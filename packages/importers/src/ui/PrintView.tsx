...
/** The shell's scroll container would cut the printout to one screen. */
const PRINT_LAYOUT = '@media print{#main{height:auto!important;overflow:visible!important}}';
