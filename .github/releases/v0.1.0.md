...
certificate in this release, so the first launch asks for your permission: on macOS, choose
**Open Anyway** in System Settings → Privacy & Security; on Windows, **More info** → **Run
anyway**.
