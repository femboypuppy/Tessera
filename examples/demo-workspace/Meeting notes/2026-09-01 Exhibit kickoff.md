...
- Maya proposed six zones, following the [[Timeline of space exploration]]:
  1. The first satellites: [[Sputnik 1]] and [[Laika]]
  2. The first people: [[Yuri Gagarin]], [[Valentina Tereshkova]], [[Project Mercury]]
  3. The Moon: [[Apollo program]], [[Apollo 11]], [[Apollo 13]]
...
> [!success] Decided
> - Six zones, in chronological order.
> - The orbit simulator is the one big interactive. Everything else is panels, objects and audio.
> - Every panel is written for age 10 and up and reviewed by Sam.

## Action items

- [x] Maya: draft the zone outline and share it by Friday
- [x] Theo: prototype the orbit simulator physics (see [[Projects]])
- [x] Priya: collect three visual directions for the panels
- [ ] Sam: contact two schools about pilot visits

Next meeting: [[2026-09-08 Content review]]
