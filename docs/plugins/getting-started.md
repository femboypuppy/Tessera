...
[`examples/plugin-template`](../../examples/plugin-template), if you'd rather copy it.
...
- The [examples](../../examples/plugins) show complete plugins: the Mermaid block is a good
