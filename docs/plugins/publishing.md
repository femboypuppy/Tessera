...
[`examples/plugins/registry.json`](../../examples/plugins/registry.json) in the Tessera
...
[`registry.schema.json`](../../examples/plugins/registry.schema.json): editors validate the file
