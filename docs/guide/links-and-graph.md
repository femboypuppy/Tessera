...
Prefer backlinks at the bottom of every page? Turn on the backlinks footer in Settings.
...
Open the graph from the sidebar or the palette (**Open graph**). Each page is a dot, each link a
line.
