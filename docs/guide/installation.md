...
2. Download the file for your system:
   ...
   | Windows               | `Tessera_<version>_x64-setup.exe` or `.msi` |
...
`pnpm dev` starts the web app with hot reload. [CONTRIBUTING.md](https://github.com/femboypuppy/Tessera/blob/main/CONTRIBUTING.md)
explains how to run the server, the desktop app and the tests.
