...
Turn on the markdown mirror in the workspace settings, and Tessera keeps a `markdown/` folder next
to your data, updated as you write. It's the same format as a markdown export: plain,
Obsidian-compatible files. Use it for grep, for backups, or for peace of mind. Edits made directly
to the mirror are not read back.
