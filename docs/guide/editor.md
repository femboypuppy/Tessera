...
| Embed          | `/embed`       |                     | YouTube, Vimeo, Loom, Figma, CodePen or a link card.    |
| Database       | `/database`    |                     | An inline database. See [Databases](./databases).       |
...
- **Click the handle** for the block menu: turn into, duplicate, delete, copy as markdown, and
  color.
- From the keyboard: <kbd>Esc</kbd> selects the current block, the arrow keys extend the selection,
...
The page menu (⋯ in the top bar) has **Full width** and **Small text**, plus word and character
counts and **Copy page as markdown**.
